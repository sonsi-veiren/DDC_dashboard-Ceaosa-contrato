...
// Parsea la hoja "Resumen" (+ "AP" para el ajuste paramétrico) de un workbook
// ya leído. Usada tanto por /api/resumen (para servir los datos) como por
// /api/upload (para validar un Excel nuevo antes de guardarlo en Blob).
export function parseResumen(workbook) {
  ...
  return { pesos, usdPlaza, usdCif, tcPlanilla, ajusteParametrico };
}
